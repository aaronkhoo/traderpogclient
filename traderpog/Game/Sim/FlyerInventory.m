...
static NSString* const kKeyEscrowItemId = @"escrow_item_info_id";
static NSString* const kKeyEscrowNumItems = @"escrownum_items";
...
{    
    ...
    [aCoder encodeObject:_orderItemId forKey:kKeyEscrowItemId];
    [aCoder encodeObject:[NSNumber numberWithUnsignedInt:_orderNumItems] forKey:kKeyEscrowNumItems];
...
- (id) initWithCoder:(NSCoder *)aDecoder
{
    ...
    _orderItemId = [aDecoder decodeObjectForKey:kKeyEscrowItemId];
    _orderNumItems = [[aDecoder decodeObjectForKey:kKeyEscrowNumItems] unsignedIntValue];
